...
//                final TiffOutputDirectory rootDirectory = outputSet.getRootDirectory()
                ...
                exifDirectory.add(ExifTagConstants.EXIF_TAG_CAMERA_OWNER_NAME, "Eigenaar van de camera");
                exifDirectory.removeField(MicrosoftTagConstants.EXIF_TAG_XPTITLE);
                exifDirectory.add(MicrosoftTagConstants.EXIF_TAG_XPTITLE, "Titel van de eigenaar");
            }
